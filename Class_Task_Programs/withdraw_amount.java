...
class Setter_withdraw{
    private int accountNumber;
    private String accountHolderName;
    private String mobileNumber;
    private String accountType;
    private double balance;
    Setter_withdraw(int accountNumber,String accountHolderName,String mobileNumber,String accountType,double balance)
    {
...
public class withdraw_amount{
    ...
    {
        Setter_withdraw g = new Setter_withdraw(1003,"Abitha","9876543210","Savings",25090.500);
