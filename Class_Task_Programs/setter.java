...
public class setter {
    ...
    {
        Setter_class g = new Setter_class(1003,"Abitha","9876543210","Savings",25090.500);
...
class Setter_class{
    ...
    Setter_class(int accountNumber,String accountHolderName,String mobileNumber,String accountType,double balance)
    {
